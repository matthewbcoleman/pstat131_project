...
final.logit.pred <- ifelse(final.logit.pred>.43, 1, 0)
...
The logistic regression model ended up being the best choice for our classification model. As with the regression model, the misclassification error rate, `r final.logit.misclass`, was slightly higher than some of the more complex models, but we decided to choose the simpler model at a small penalty to misclassification rate. We can interpret the most important coefficients as follows:
