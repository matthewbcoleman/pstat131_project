...
```{r, eval=FALSE}
xtrain <- cbind(train$neighbourhood_group, train$latitude, train$longitude, train$room_type, train$minimum_nights, train$number_of_reviews, train$calculated_host_listings_count, train$availability_365)
