...
#XTrain <- X[train.ind,]
#yTrain <- y[train.ind]
#RidgeTr <- glmnet(x = XTrain, y = yTrain, alpha = 0, lambda = lambda.best)
#XTest <- X[-train.ind,]
#yTest <- y[-train.ind]
#Ridge.pred <- Ridge$a0 + XTest%*%RidgeTr$beta
