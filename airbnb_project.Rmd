...
The test MSE for ridge and lasso regression were both aroun 0.42. It makes sense that these models would have worse test MSE values than other models since both ridge and lasso were unable to run with the non-numeric predictors. When we compare with the results previously, we see that some of the non-numeric (such as room-type and neighborhood group) were very important in predicting in other models.
